              ...
              >
                ...
                <div className="details w-full text-white font-Poppins px-4 py-2 md:px-8 md:py-8 flex flex-col gap-6 relative">
                  ...
                  <div className="project-details text-xs   text-zinc-200 md:text-sm md:leading-6 tracking-wide ">
                    <p>
                      Youtube Clone is a web application built using React.js
                      that allows users to watch videos. It uses the YouTube API
                      to show videos and provide an experience similar to
                      YouTube. The application also comes with features such as
                      a highly optimized search feature using debouncing and
                      caching.
                    </p>
                  </div>
                  ...
                  <div className="project-links">
                    <div className="md:mt-6 mb-3 flex justify-end gap-10 items-center">
                      <a
                        href="https://github.com/Nischit17/React-Class-YT"
